...
public class LivroBO implements BaseInterBO<LivroVO> {
	...
	public void inserir(LivroVO entidade) throws SQLException {
		...
		try {
			...
			if (resposta.next()) {
				throw new Exception("J� existe livro cadastrado com esse ID.");
			} else {
	...
	public void editar(LivroVO entidade) throws SQLException {
		...
		try {
			ResultSet resposta = livro.buscarPorId(entidade);
			if (!resposta.next()) {
				throw new Exception("N�o existe esse livro.");
			} else {
				dao.editar(entidade);
			}
		} catch (Exception erro) {
	...
	public List<LivroVO> buscarPorAutor(LivroVO liv) throws SQLException {
		...
		try {
			...
			if (!resposta.next()) {
				throw new Exception("N�o existe esse autor.");
			} else {
	...
	public List<LivroVO> buscarPorAno(LivroVO liv) throws SQLException {
		...
		try {
			...
			if (!resposta.next()) {
				throw new Exception("N�o existe nenhum livro cadastrado desse ano.");
			} else {
	...
	public List<LivroVO> buscarPorGenero(LivroVO liv) throws SQLException {
		...
		try {
			...
			if (!resposta.next()) {
				throw new Exception("N�o existe nenhum livro cadastrado com desse genero.");
			} else {
